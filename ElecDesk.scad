...
module frame() {
    ...
    // laterale
    translate([e,cote_l-e,e]) planche(L-2*e-2*porte_e-charnier_e, e,H-2*e);
    translate([e,l-(cote_l),e]) planche(L-2*e-2*porte_e-charnier_e, e,H-2*e);
    //renfort laterale
    color("red") translate([e,0,e]) planche(e,cote_l-e,H-2*e);
    color("red") translate([e,l-cote_l+e,e]) planche(e,cote_l-e,H-2*e);
    color("pink")translate([L-(e+2*porte_e+charnier_e),0,e]) planche(porte_e,cote_l, H-2*e);
    color("pink")translate([L-(e+2*porte_e+charnier_e),l-cote_l,e]) planche(porte_e,cote_l, H-2*e);
    // portes laterales
    ...
    //portes frontales
    translate([L-(e+porte_e),0,e+charnier_e]) rotate([0,0,-120]) difference() {
        planche(e,l/2,H-(2*e+charnier_e));
        translate([-0.1,l/2-50,H-(2*e+charnier_e)-50]) rotate([0,90,0]) cylinder(d=30, h=5.2);
    }
    translate([L-(e+porte_e),l,e+charnier_e]) rotate([0,0,120]) translate([0,-l/2,0])  difference() {
        planche(e,l/2,H-(2*e+charnier_e));
...
module all() {
    ...
    translate([e+blocAlim_L+40+40,cote_l,e]) rotate([90,0,90]) plaqueAlim();
